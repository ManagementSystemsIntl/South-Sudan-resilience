...
```{r echo=T, fig.cap="Age distribution of all household members, Wau"}
...
ggsave(here("output/viz/Paynijar/age density, Paynijar.png"),
       age_dens,
       device="png",
       type="cairo",
       height=4,
...
```{r echo=T, fig.cap="Age distribution of all household members, Paynijar"}
include_graphics(here("output/viz/Paynijar/age density, Paynijar.png"))
```
...
ggsave(here("output/viz/Paynijar/age pyramid, Paynijar.png"),
       pyr,
       device="png",
       type="cairo",
       height=4,
...
```{r echo=T, fig.cap="Pyramid plot of age groups by sex, all household members"}
include_graphics(here("output/viz/Paynijar/age pyramid, Paynijar.png"))
```
...
write_csv(ed, here("output/tables/Paynijar/education hh Paynijar.csv"))
...
save_as_docx(ed_flx, path=here("output/tables/Paynijar/education hh Paynijar.docx"))
...
payn_ec <-ec_act_cnty_lst$`Paynijar` %>%
  arrange(desc(freq))
...
payn_inc <- inc_cnty_lst$`Paynijar`
...
write_csv(insec, here("output/tables/Paynijar/food insecurity indicators Paynijar.csv"))
...
write_csv(hlth, here("output/tables/Paynijar/health table Paynijar.csv"))

```

```{r}

#hlth <- read_csv(here("output/tables/Paynijar/health table Paynijar.csv"))
...
save_as_docx(hlth_flx, path=here("output/tables/Paynijar/health table Paynijar.docx"))
...
#out
write_csv(out, here("output/tables/Paynijar/health service and satisfaction, Paynijar.csv"))
```
...
#  width(j=9, width=1, unit="in") %>%
  align(j=c(3, 5:6),
        align="center",
        part="all") %>%
  set_caption("Health clinic satisfaction by service, Paynijar")
#  add_footer_lines(values="Health clinic satisfaction by service")

out_flx  

save_as_docx(out_flx, path=here("output/tables/Paynijar/health service with satisfaction Paynijar.docx"))
