...
fa_sev_5_scores <- fa_sev_5$scores %>%
  as.data.frame() %>%
  set_names(nm=c("shock_sev_crops", "shock_sev_livestock","shocks_sev_drought", "shocks_sev_illdeath", "shocks_sev_theft"))
...
dat <- dat %>%
  mutate(shock_sev_crops=fa_sev_5_scores$shock_sev_crops,
         ...
         shock_sev_drought=fa_sev_5_scores$shocks_sev_drought,
...
```
```{r}
ggplot(dat, aes(shock_exposure_index, shock_exposure_comp)) + 
